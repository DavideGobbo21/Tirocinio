...
#file delle immagini da analizzare
CARTELLA_IMMAGINI = Path(r"C:\Users\TheDa\Pictures\compressa")
#file excel di output (se non esiste viene creato) (chiamato come il modello per riconoscerlo facilmente)
FILE_EXCEL        = Path(r"C:\Users\TheDa\progetto\ministral33b.xlsx")
